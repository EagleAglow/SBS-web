...
@section('title', '| Bid Schedule Line - remove this blade????????')
	...
	<div class="row justify-content-center">
		<div class="col-md-8">
			<div class="card mt-5 shadow">
				<div class="card-header"><h5>If bidding works without this page, remove it - Bid Schedule Line:&nbsp; {{$schedule_line->line}}</h5>
                </div>
					<div class="card-body">
                    <form method="POST" action="{{ route('schedulelines.update', $schedule_line->id) }}" accept-charset="UTF-8">
                        @csrf
                        @method('PUT')
