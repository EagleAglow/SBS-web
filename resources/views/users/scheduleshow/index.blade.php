                ...
                @else
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6">
{{--
                                cycle $my_sort between 'filter', 'traffic', 'com', all', but only use 'traffic' and 'com' if both are in $list
                                $tandc is 'yes' if both are in sequence
--}}                            
                                @if($tandc == 'yes')
                                    @if($my_sort == 'all')
                                        ...
                                        <form action="{{ url('users/scheduleshow' , $schedule->id ) }}" method="GET">
                                            ...
                                            <input type="hidden" name="my_sort" value="traffic">
                                            @csrf
                                    ...
                                    @else
                                        @if($my_sort == 'traffic')
                                            ...
                                            <form action="{{ url('users/scheduleshow' , $schedule->id ) }}" method="GET">
                                                ...
                                                <input type="hidden" name="last_day" value="{{ $last_day - $delta }}">
                                                <input type="hidden" name="page" value="1">
                                                <input type="hidden" name="my_sort" value="commercial">
                                                @csrf
                        ...
                        <div class="table-responsive-md">
                            <table class="table table-striped">
                                ...
                                <form action="{{ url('users/scheduleshow' , $schedule->id ) }}" method="GET">
                                    ...
                                    <input type="hidden" name="tandc" value={{$tandc}}>
                                    @csrf
...
--}}
                                    ...
                                    @php
                                        ...
                                        $params = array( 'first_day'=>$first_day,'last_day'=>$last_day,'my_sort'=>$my_sort,'tandc'=>$tandc);
                                    @endphp
