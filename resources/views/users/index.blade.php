		...
		<div class="col-md-12">
			<div class="card shadow">
                <div class="card-header">
                    <div class="flex row"><div class="col">Admin Dashboard - Users</div>
                        <div class="col">
                ...
                <div class="card-body my-squash">
                    <div class="table-responsive-md">
						...
						<tbody>
							...
							<td class="text-center"><span style="padding:0 0.5rem;border:1px solid #ccc;border-radius:0.25rem;">{{ $user->bidder_primary_order }}</span><br>{{ $user->bidder_secondary_order }}</td>
