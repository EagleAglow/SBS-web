        ...
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="card-body my-squash"><b>Bidders By Bidder Role</b><br>
                   <span style="font-size:0.8rem;">Bidders in the TRAFFIC bidder group have roles of both "bidder-tcom" and "bidder-tnon",
                   so the count for "bidder-tcom" should equal TRAFFIC+TCOM and the count for "bidder-tnon" should equal the count for "TRAFFIC+TNON".</span>
                </div>
                    ...
                    <table class="table compact">
                        <thead>
                            ...
                            @php
                                ...
                                foreach($groups as $group){
                                    $xref = 'bidder-' . strtolower($group->code);
                                ...
                                foreach($bidders_by_role as $role_name=>$role_count){
                                    if ($role_name == 'bidder-tcom'){
                                        ...
                                        if ($role_name == 'bidder-tnon'){
                                            ...
                                            if ($role_count == $bidders_by_group[ strtoupper(str_replace("bidder-","",$role_name)  )     ]){
                                                $flags_by_role[$role_name] = 'OK';
                                            } else {
                                                $flags_by_role[$role_name] = '<span style="color:red;">CHECK</span>';
                                            }
