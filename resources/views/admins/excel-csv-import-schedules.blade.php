    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <hr>                
                <div class="card-body my-squash">
                    Import file must use the format of the export file, including header row. Do not use codes/names for shifts/groups/schedules that are not already in the system.
