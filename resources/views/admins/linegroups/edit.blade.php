	...
	<div class="row justify-content-center">
		<div class="col-md-8">
			<div class="card mt-5 shadow">
                ...
                <div class="card-body">Some comment goes here about line groups.
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('linegroups.update', $line_group->id) }}" accept-charset="UTF-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code') ? old('code') : $line_group->code }}" required autocomplete="code" autofocus>
                                @error('code')
