...
class CreateExtrasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('extras', function (Blueprint $table) {
            ...
            $table->string('voice_number')->nullable()->default(''); // actual human phone call (contact info1)
            ...
            $table->decimal('offered', 3, 2)->nullable();  // three decimal precision, two decimal display?
