...
class ShiftCodesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('shift_codes')->insertOrIgnore([ 'name' => '----', 'begin_time' => Null, 'end_time' => Null, ]);   // used for 'Day Off'
        DB::table('shift_codes')->insertOrIgnore([ 'name' => '????', 'begin_time' => Null, 'end_time' => Null, ]);   // used for 'Missing Data'

        DB::table('shift_codes')->insertOrIgnore([ 'name' => '06BL', 'begin_time' => '06:45', 'end_time' => '17:15', ]); // time guestimated
        ...
        DB::table('shift_codes')->insertOrIgnore([ 'name' => '07AQ', 'begin_time' => '07:00', 'end_time' => '17:30', ]);  // time guestimated
        ...
        DB::table('shift_codes')->insertOrIgnore([ 'name' => '08FZ', 'begin_time' => '08:45', 'end_time' => '19:15', ]);  // time guestimated
        ...
        DB::table('shift_codes')->insertOrIgnore([ 'name' => '11AT', 'begin_time' => '11:24', 'end_time' => '21:00', ]);  // time guestimated
        ...
        DB::table('shift_codes')->insertOrIgnore([ 'name' => '12CW', 'begin_time' => '12:54', 'end_time' => '22:00', ]);  // time guestimated
        ...
        DB::table('shift_codes')->insertOrIgnore([ 'name' => '13BB', 'begin_time' => '13:45', 'end_time' => '00:15', ]);  // time guestimated

        DB::table('shift_codes')->insertOrIgnore([ 'name' => '14AS', 'begin_time' => '14:24', 'end_time' => '00:00', ]);
        DB::table('shift_codes')->insertOrIgnore([ 'name' => '14AT', 'begin_time' => '14:24', 'end_time' => '00:00', ]);  // time guestimated
        ...
        DB::table('shift_codes')->insertOrIgnore([ 'name' => '20AT', 'begin_time' => '20:30', 'end_time' => '07:00', ]);  // time guestimated
